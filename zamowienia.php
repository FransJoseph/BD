...
<form method="POST" action="zapiszOperacje.php" id="form">
...
<button id="dodajPozycje">Dodaj pozycję</button>
...
<script>
    document.getElementById("dodajPozycje").addEventListener("click",addItem);
        cont towar = document.getElementById("towar");
    function addItem(){
        documnet.getElementById("form").appendChild(towar);
        return false;
    }
